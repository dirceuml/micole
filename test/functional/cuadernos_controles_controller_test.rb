...
class CuadernosControlesControllerTest < ActionController::TestCase
  setup do
    @cuaderno_control = cuadernos_controles(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:cuadernos_controles)
  end
  ...
  test "should destroy cuaderno_control" do
    ...
    assert_redirected_to cuadernos_controles_path
  end
end
